...
RSpec.describe "raft_checks/new", :type => :view do
  before(:each) do
    assign(:raft_check, RaftCheck.new(
  ...
  it "renders new raft_check form" do
    render

    assert_select "form[action=?][method=?]", raft_checks_path, "post" do
