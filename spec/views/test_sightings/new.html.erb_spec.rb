...
RSpec.describe "test_sightings/new", :type => :view do
  before(:each) do
    assign(:test_sighting, TestSighting.new(
      :x_coord => "MyString",
      :y_coord => "MyString",
      :date => "MyString",
      :your_name => "MyString",
  ...
  it "renders new test_sighting form" do
    render

    assert_select "form[action=?][method=?]", test_sightings_path, "post" do
