...
ActiveRecord::Schema.define(version: 20151001125105) do

  create_table "raft_checks", force: :cascade do |t|
  ...
  add_index "raft_checks", ["raft_code"], name: "index_raft_checks_on_raft_code"
